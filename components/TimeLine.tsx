...
const schedule: ScheduleData = {
  day1: {
    ...
    events: [
      ...
      {time: "1:00 PM - 1:30 PM", item: "Making Better Hacks Faster With GitHub Copilot", responsibility: "MLH", venue: "Room 112" },
      ...
      {time: "1:30 PM - 2:00 PM", item: "Intro to Google AI Studio", responsibility: "MLH", venue: "Room 112" },
