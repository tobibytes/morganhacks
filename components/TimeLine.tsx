...
const schedule: ScheduleData = {
  day1: {
    ...
    events: [
      ...
      {time: "2:00 PM - 2:30 PM", item: "Making Better Hacks Faster With GitHub Copilot", responsibility: "MLH", venue: "Room 112" },
      { time: "2:00 PM – 3:00 PM", item: "Workshop 1 – Northrop Grumman: A Day in the Life of an Engineer Panel with Yeneneh Ketema", responsibility: "Northrop Grumman", venue: "Room 208" },
      { time: "1:00 PM – 3:00 PM", item: "Lunch Served", responsibility: "Logistics / Volunteers", venue: "First Floor" },
      {time: "2:30 PM - 3:00 PM", item: "Intro to Google AI Studio", responsibility: "MLH", venue: "Room 112" },
